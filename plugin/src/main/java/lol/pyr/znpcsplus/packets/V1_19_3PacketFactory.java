  ...
  public CompletableFuture<Void> addTabPlayer(
    ...
    Component displayName =
        tabListDisplayNameProperty != null
                && properties.hasProperty(tabListDisplayNameProperty.get())
            ? PapiUtil.set(
                    ...
                    configManager
                        ...
                        .replace(
                            ...
                            displayNameProperty != null
                                ...
                                : "")));
    boolean listed =
        alwaysVisibleInTabProperty == null
            ...
            profile -> {
              WrapperPlayServerPlayerInfoUpdate.PlayerInfo info =
                  new WrapperPlayServerPlayerInfoUpdate.PlayerInfo(
                      profile, listed, 1, GameMode.CREATIVE, displayName, null);
              sendPacket(
                  player,
  ...
  public void updateListed(Player player, PacketEntity entity, boolean listed) {
    ...
    sendPacket(
        ...
        new WrapperPlayServerPlayerInfoUpdate(
            WrapperPlayServerPlayerInfoUpdate.Action.UPDATE_LISTED,
            new WrapperPlayServerPlayerInfoUpdate.PlayerInfo(
                new UserProfile(entity.getUuid(), null),
                listed,
                1,
                GameMode.CREATIVE,
                null,
