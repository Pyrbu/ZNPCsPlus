...
public final class RepeatingTaskGuard {
  ...
  private RepeatingTaskGuard(Logger logger, String taskName, long minErrorLogIntervalMs) {
    ...
    if (minErrorLogIntervalMs < 0)
      throw new IllegalArgumentException("minErrorLogIntervalMs must be >= 0");
  ...
  public static Runnable wrap(
      Logger logger, String taskName, Runnable runnable, long minErrorLogIntervalMs) {
