...
public class ComponentPropertySerializer implements PropertySerializer<Component> {
  ...
  public String serialize(Component property) {
    return Base64.getEncoder()
        .encodeToString(
            MiniMessage.miniMessage().serialize(property).getBytes(StandardCharsets.UTF_8));
  }

  @Override
  public Component deserialize(String property) {
    return MiniMessage.miniMessage()
        .deserialize(new String(Base64.getDecoder().decode(property), StandardCharsets.UTF_8));
  }
