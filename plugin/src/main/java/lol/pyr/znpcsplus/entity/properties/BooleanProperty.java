...
public class BooleanProperty extends EntityPropertyImpl<Boolean> {
  ...
  public BooleanProperty(
      String name, int index, boolean defaultValue, boolean legacy, boolean inverted) {
  ...
  public void apply(
    ...
    if (legacy)
      properties.put(index, newEntityData(index, EntityDataTypes.BYTE, (byte) (enabled ? 1 : 0)));
