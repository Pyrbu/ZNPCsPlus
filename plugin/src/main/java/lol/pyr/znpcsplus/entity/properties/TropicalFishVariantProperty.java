...
public class TropicalFishVariantProperty<T> extends EntityPropertyImpl<T> {
  ...
  public TropicalFishVariantProperty(
      String name, T defaultValue, Class<T> type, int index, BuilderDecoder<T> decoder) {
  ...
  public TropicalFishVariantProperty(
      String name, T defaultValue, int index, BuilderDecoder<T> decoder) {
  ...
  public void apply(
    ...
    if (oldData != null
        && oldData.getType() == EntityDataTypes.INT
        && oldData.getValue() instanceof Integer) {
