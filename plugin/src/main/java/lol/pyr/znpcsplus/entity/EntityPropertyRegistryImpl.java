...
/**
 * 1.8 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2767708">...</a>
 * 1.9 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768074">...</a>
 * 1.10 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768201">...</a>
 * 1.11 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768444">...</a>
 * 1.12 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768647">...</a>
 * 1.13 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768701">...</a>
 * 1.14 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768716">...</a>
 * 1.15 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2768877">...</a>
 * 1.16 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2769100">...</a>
 * 1.17 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2769318">...</a>
 * 1.18-1.19 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2769409">...</a>
 * 1.20 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata?oldid=2769476">...</a>
 * 1.21 <a
 * href="https://minecraft.wiki/w/Minecraft_Wiki:Projects/wiki.vg_merge/Entity_metadata">...</a>
 */
...
public class EntityPropertyRegistryImpl implements EntityPropertyRegistry {
  ...
  public EntityPropertyRegistryImpl(MojangSkinCache skinCache, ConfigManager configManager) {
    ...
    registerSerializer(
        new GenericSerializer<>(Vector3i::toString, Vector3i::fromString, Vector3i.class));
  ...
  public void registerTypes(
    ...
    register(
        new DummyProperty<>("look_distance", configManager.getConfig().lookPropertyDistance()));
    ...
    register(
        new EncodedIntegerProperty<>("potion_color", Color.class, potionIndex++, Color::asRGB));
    ...
    register(
        new RotationProperty("left_arm_rotation", armorStandIndex++, new Vector3f(-10, 0, -10)));
    register(
        new RotationProperty("right_arm_rotation", armorStandIndex++, new Vector3f(-15, 0, 10)));
    ...
    register(
        new EncodedIntegerProperty<>(
            "creeper_state", CreeperState.IDLE, creeperIndex++, CreeperState::getState));
    ...
    register(
        new BitsetProperty("has_mouth_open", horseIndex, horseEating << 2, false, legacyBooleans));
    ...
    if (ver.isOlderThan(ServerVersion.V_1_11)) {
      ...
      register(
          new BitsetProperty("is_retracting_spikes", guardianIndex, 0x02, false, legacyBooleans));
    ...
    if (ver.isNewerThanOrEquals(ServerVersion.V_1_8) && ver.isOlderThan(ServerVersion.V_1_9)) {
      register(
          new EncodedByteProperty<>(
              "horse_type", HorseType.HORSE, 19, obj -> (byte) obj.ordinal()));
      ...
      register(
          new EncodedIntegerProperty<>(
              "horse_type", HorseType.HORSE, horseTypeIndex, Enum::ordinal));
    }
    ...
    if (ver.isOlderThan(ServerVersion.V_1_14)) {
      ...
      register(
          new EncodedIntegerProperty<>(
              "horse_armor", HorseArmor.NONE, horseArmorIndex, Enum::ordinal));
    }
    ...
    if (ver.isOlderThan(ServerVersion.V_1_11)) {
      ...
      linkProperties(
          "is_tame", "is_saddled", "has_chest", "is_eating", "is_rearing", "has_mouth_open");
    } else {
    ...
    if (ver.isOlderThan(ServerVersion.V_1_14)) {
      ...
      if (legacyBooleans)
        register(
            new EncodedByteProperty<>(
                "ocelot_type", OcelotType.OCELOT, ocelotIndex, obj -> (byte) obj.ordinal()));
      else
        register(
            new EncodedIntegerProperty<>(
                "ocelot_type", OcelotType.OCELOT, ocelotIndex, Enum::ordinal));
    }
    ...
    register(
        new EncodedByteProperty<>(
            "sheep_color", DyeColor.WHITE, sheepIndex, DyeColor::getWoolData));
    register(
        new BitsetProperty(
            "sheep_sheared",
            sheepIndex,
            0x10,
            false,
            legacyBooleans)); // no need to link because sheep_sheared is only visible when
                              // sheep_color is WHITE
    ...
    if (ver.isOlderThan(ServerVersion.V_1_14)) {
      ...
      register(
          new EncodedIntegerProperty<>(
              ...
              villagerIndex,
              VillagerProfession::getLegacyId));
    }
    ...
    if (legacyBooleans) {
      ...
      register(
          new EncodedByteProperty<>(
              "wolf_collar", DyeColor.BLUE, wolfIndex++, DyeColor::getDyeData));
    } else
      register(
          new EncodedIntegerProperty<>("wolf_collar", DyeColor.RED, wolfIndex++, Enum::ordinal));
    ...
    if (ver.isOlderThan(ServerVersion.V_1_11)) {
      if (legacyBooleans)
        register(
            new EncodedByteProperty<>(
                "skeleton_type", SkeletonType.NORMAL, 13, SkeletonType::getLegacyId));
      else
        register(
            new EncodedIntegerProperty<>(
                "skeleton_type",
                SkeletonType.NORMAL,
                ver.isOlderThan(ServerVersion.V_1_10) ? 11 : 12,
                Enum::ordinal));
    }
    ...
    if (ver.isOlderThan(ServerVersion.V_1_9)) {
      register(
          new EncodedByteProperty<>(
              "zombie_is_villager", false, zombieIndex++, b -> (byte) (b ? 1 : 0)));
    } else if (ver.isOlderThan(ServerVersion.V_1_11)) {
      register(
          new EncodedIntegerProperty<>(
              "zombie_type", ZombieType.ZOMBIE, zombieIndex++, Enum::ordinal));
    } else {
    ...
    if (ver.isOlderThan(ServerVersion.V_1_9)) {
      register(
          new EncodedByteProperty<>(
              "is_converting", false, zombieIndex++, b -> (byte) (b ? 1 : 0)));
    } else if (ver.isOlderThan(ServerVersion.V_1_11)) {
    ...
    if (ver.isNewerThanOrEquals(ServerVersion.V_1_13)) {
      register(
          new BooleanProperty("zombie_becoming_drowned", zombieIndex++, false, legacyBooleans));
    }
    ...
    register(
        new CustomTypeProperty<>(
            ...
            attachDir -> BlockFace.valueOf(attachDir.name())));
    register(
        new EncodedByteProperty<>(
            "shield_height", 0, shulkerIndex++, value -> (byte) Math.max(0, Math.min(100, value))));
    // noinspection deprecation
    register(
        new EncodedByteProperty<>(
            "shulker_color", DyeColor.class, shulkerIndex, DyeColor::getWoolData));
    ...
    register(
        new EncodedByteProperty<>(
            ...
            SpellType.NONE,
            spellIndex,
            obj -> (byte) Math.min(obj.ordinal(), ver.isOlderThan(ServerVersion.V_1_13) ? 3 : 5)));
    ...
    if (!ver.isNewerThanOrEquals(ServerVersion.V_1_21))
      register(
          new EncodedIntegerProperty<DyeColor>(
              "carpet_color",
              DyeColor.class,
              llamaIndex++,
              obj -> obj == null ? -1 : obj.ordinal()));
    register(
        new EncodedIntegerProperty<>(
            "llama_variant", LlamaVariant.CREAMY, llamaIndex, Enum::ordinal));
    ...
    register(
        new EncodedIntegerProperty<>(
            "parrot_variant", ParrotVariant.RED_BLUE, parrotIndex, Enum::ordinal));

    // Player
    NBTProperty.NBTDecoder<ParrotVariant> parrotVariantDecoder =
        (variant) -> {
    ...
    register(
        new EncodedIntegerProperty<>(
            "puff_state", PuffState.DEFLATED, pufferfishIndex, Enum::ordinal));
    ...
    register(
        new TropicalFishVariantProperty<>(
            "tropical_fish_pattern",
            TropicalFishVariant.TropicalFishPattern.KOB,
            tropicalFishIndex,
            TropicalFishVariant.Builder::pattern));
    register(
        new TropicalFishVariantProperty<>(
            "tropical_fish_body_color",
            DyeColor.WHITE,
            tropicalFishIndex,
            TropicalFishVariant.Builder::bodyColor));
    register(
        new TropicalFishVariantProperty<>(
    ...
    linkProperties(
        "tropical_fish_pattern", "tropical_fish_body_color", "tropical_fish_pattern_color");
    ...
    register(
        new CustomTypeProperty<>(
            ...
            npcPose -> EntityPose.valueOf(npcPose.name())));
    ...
    register(
        new VillagerProfessionProperty(
            "villager_profession", villagerIndex, VillagerProfession.NONE));
    ...
    register(
        new EncodedIntegerProperty<>("fox_variant", FoxVariant.RED, foxIndex++, Enum::ordinal));
    ...
    register(
        new EncodedStringProperty<>(
            "mooshroom_variant",
            MooshroomVariant.RED,
            mooshroomIndex,
            MooshroomVariant::getVariantName));
    ...
    register(
        new EncodedByteProperty<>(
            "panda_main_gene", PandaGene.NORMAL, pandaIndex++, obj -> (byte) obj.ordinal()));
    register(
        new EncodedByteProperty<>(
            "panda_hidden_gene", PandaGene.NORMAL, pandaIndex++, obj -> (byte) obj.ordinal()));
    ...
    if (ver.isNewerThanOrEquals(ServerVersion.V_1_17))
      zombificationIndex =
          17; // Change piglinIndex, pillagerIndex, striderIndex and vindicatorIndex if you change
              // this
    else zombificationIndex = 16;
    register(
        new BooleanProperty(
            "hoglin_immune_to_zombification", zombificationIndex, false, legacyBooleans));
    register(
        new BooleanProperty(
            "piglin_immune_to_zombification", zombificationIndex - 1, false, legacyBooleans));
    ...
    register(
        new BooleanProperty(
            ...
            striderIndex++,
            false,
            legacyBooleans)); // TODO: Fix this, it needs to be set constantly i guess
    ...
    // Axolotl
    register(
        new EncodedIntegerProperty<>("axolotl_variant", AxolotlVariant.LUCY, 17, Enum::ordinal));
    ...
    // Warden
    register(
        new EncodedIntegerProperty<>("warden_anger", 0, 16, b -> Math.min(150, Math.max(0, b))));
    ...
    register(
        new CustomTypeProperty<>(
            ...
            state ->
                com.github.retrooper.packetevents.protocol.entity.sniffer.SnifferState.valueOf(
                    state.name())));
    ...
    register(
        new CustomTypeProperty<>(
            ...
            state ->
                com.github.retrooper.packetevents.protocol.entity.armadillo.ArmadilloState.valueOf(
                    state.name())));
    ...
    register(
        new CustomTypeProperty<>(
            ...
            nautilusIndex,
            ZombieNautilusVariant.TEMPERATE,
            EntityDataTypes.ZOMBIE_NAUTILUS_VARIANT,
            variant ->
                ZombieNautilusVariants.getRegistry()
                    .getByNameOrThrow(variant.name().toLowerCase())));
  }
  ...
  private void linkProperties(String... names) {
    linkProperties(Arrays.stream(names).map(this::getByName).collect(Collectors.toSet()));
  }
