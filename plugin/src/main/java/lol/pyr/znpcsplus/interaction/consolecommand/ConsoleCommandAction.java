...
public class ConsoleCommandAction extends InteractionActionImpl {
  ...
  public void run(Player player) {
    ...
    scheduler.runSyncGlobal(
        () -> Bukkit.dispatchCommand(Bukkit.getConsoleSender(), PapiUtil.set(player, cmd)));
  }
  ...
  public Component getInfo(String id, int index, CommandContext context) {
    return Component.text(index + ") ", NamedTextColor.GOLD)
        .append(
            Component.text("[EDIT]", NamedTextColor.DARK_GREEN)
                .hoverEvent(
                ...
                .append(Component.text(" | ", NamedTextColor.GRAY))
                .append(
                    Component.text("Console Command: ", NamedTextColor.GREEN)
                        .hoverEvent(
                            HoverEvent.hoverEvent(
                                HoverEvent.Action.SHOW_TEXT,
                                Component.text(
