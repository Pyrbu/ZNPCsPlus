...
public class SkinImpl implements Skin {
  ...
  public SkinImpl(Object propertyMap) {
    ...
    try {
      Collection<?> properties =
          (Collection<?>) Reflections.PROPERTY_MAP_VALUES_METHOD.get().invoke(propertyMap);
  ...
  public String getTexture() {
    for (TextureProperty property : properties)
      if (property.getName().equalsIgnoreCase("textures")) return property.getValue();
    return null;
  }
  ...
  public String getSignature() {
    for (TextureProperty property : properties)
      if (property.getName().equalsIgnoreCase("textures")) return property.getSignature();
    return null;
  }
}
