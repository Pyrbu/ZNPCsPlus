        ...
        LazyLoader.of(
            () ->
                new ZNpcImporter(
                    ...
                    propertyRegistry,
                    skinCache,
                    new File(pluginsFolder, "ServersNPC/data.json"),
                    bungeeConnector)));
    register(
        "znpcsplus_legacy",
        LazyLoader.of(
            () ->
                new ZNpcImporter(
                    ...
                    propertyRegistry,
                    skinCache,
                    new File(pluginsFolder, "ZNPCsPlusLegacy/data.json"),
                    bungeeConnector)));
    register(
        "citizens",
        LazyLoader.of(
            () ->
                new CitizensImporter(
                    configManager,
                    adventure,
                    taskScheduler,
                    packetFactory,
                    ...
                    propertyRegistry,
                    skinCache,
                    new File(pluginsFolder, "Citizens/saves.yml"),
                    npcRegistry)));
    register(
        "fancynpcs",
        LazyLoader.of(
            () ->
                new FancyNpcsImporter(
                    configManager,
                    adventure,
                    taskScheduler,
                    packetFactory,
                    ...
                    propertyRegistry,
                    skinCache,
                    new File(pluginsFolder, "FancyNpcs/npcs.yml"),
                    npcRegistry)));
  }
