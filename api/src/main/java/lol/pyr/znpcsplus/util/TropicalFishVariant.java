...
public class TropicalFishVariant {
  ...
  public TropicalFishVariant(
      TropicalFishPattern pattern, DyeColor bodyColor, DyeColor patternColor) {
  ...
  public int getVariant() {
    return pattern.getId() & '\uffff'
        | (bodyColor.ordinal() & 255) << 16
        | (patternColor.ordinal() & 255) << 24;
  }
  ...
  public enum TropicalFishPattern {
    ...
    private static final IntFunction<TropicalFishPattern> BY_ID =
        (id) -> {
