...
/**
 * Class responsible for providing entity property keys Some property keys are only registered in
 * certain situations for example different minecraft versions
 */
public interface EntityPropertyRegistry {
  ...
  /**
   * Get a property key by it's name and automatically cast the property to the proper type If you
   * don't know the type of the property you are requesting use {@link
   * EntityPropertyRegistry#getByName(String)} instead
   *
   * @param name The name of a property key
