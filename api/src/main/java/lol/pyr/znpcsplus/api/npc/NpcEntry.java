...
/**
 * Base class for all NPC entries An NPC entry is a wrapper around an NPC that contains additional
 * information
 */
public interface NpcEntry {
  ...
  /**
   * Enables everything for this NPC entry That is, it makes the NPC processed, saveable, and allows
