...
public interface EntityProperty<T> {
  /**
   * The default value of this property, if this is provided in {@link
   * PropertyHolder#setProperty(EntityProperty, Object)} as the value the property will be removed
   * from the holder
   *
